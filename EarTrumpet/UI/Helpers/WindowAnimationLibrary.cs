...
{
    private const int _animationOffset = 25;
    ...
    public static void BeginFlyoutExitanimation(Window window, Action completed)
    {
        ...
        moveAnimation.To = taskbarPosition switch
        {
            WindowsTaskbar.Position.Left => window.Left - _animationOffset,
            WindowsTaskbar.Position.Right => window.Left - _animationOffset,
            WindowsTaskbar.Position.Top => window.Top - _animationOffset,
            _ => (double?)(window.Top + _animationOffset),
        };
