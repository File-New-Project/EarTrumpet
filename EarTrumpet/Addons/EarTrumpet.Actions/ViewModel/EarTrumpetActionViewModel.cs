...
public class EarTrumpetActionViewModel : SettingsPageViewModel
{
    ...
    public List<ContextMenuItem> NewTriggers => [.. PartViewModelFactory.Create<BaseTrigger>().Select(t => MakeItem(t)).OrderBy(t => t.DisplayName)];
    public List<ContextMenuItem> NewConditions => [.. PartViewModelFactory.Create<BaseCondition>().Select(t => MakeItem(t)).OrderBy(t => t.DisplayName)];
    public List<ContextMenuItem> NewActions => [.. PartViewModelFactory.Create<BaseAction>().Select(t => MakeItem(t)).OrderBy(t => t.DisplayName)];
