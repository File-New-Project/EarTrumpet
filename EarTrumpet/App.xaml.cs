...
namespace EarTrumpet
{
    ...
    {
        private EarTrumpet.CLIServices.CliRoutingService _cliRoutingService; //added by dayeggpi
        ...
        private void OnAppStartup(object sender, StartupEventArgs e)
        {
            ...
            //added by dayeggpi
            _cliRoutingService = new EarTrumpet.CLIServices.CliRoutingService(this);
            if (_cliRoutingService.TryHandleCliArgs(e.Args))
            {
                return;
            }
            //END
