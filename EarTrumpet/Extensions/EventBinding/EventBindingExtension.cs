...
public class BindingExtension : MarkupExtension
{
    ...
    {
        var target = ResolvePropertyPath((sender as FrameworkElement).DataContext, Path, out var functionName);
        target.GetType().GetMethod(functionName).Invoke(target, [sender, args]);
    }
