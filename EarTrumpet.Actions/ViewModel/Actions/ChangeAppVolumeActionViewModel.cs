...
{
    class ChangeAppVolumeActionViewModel : PartViewModel
    {
        ...
        private ChangeAppVolumeAction _action;

        public ChangeAppVolumeActionViewModel(ChangeAppVolumeAction action) : base(action)
        {
            _action = action;
